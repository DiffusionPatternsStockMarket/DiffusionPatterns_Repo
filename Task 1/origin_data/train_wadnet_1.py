...
filename = 'data-1d-{}-pp.csv'.format(l)
...
try:
    pickle.dump(history_train, open(model_path + 'history_train_{}.pkl'.format(args.l), 'wb'))
    pickle.dump(history_valid, open(model_path + 'history_valid_{}.pkl'.format(args.l), 'wb'))
except:
    pass